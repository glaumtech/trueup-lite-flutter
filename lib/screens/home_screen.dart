              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildFeatureCard(
                    ...
                    title: 'Purchase V2',
                    subtitle: 'Stock receiving + expiry',
                    onTap: () => context.go('/purchase-v2'),
                  ...
                  _buildFeatureCard(
                    ...
                    subtitle: 'View bill + expiry data',
                    onTap: () => context.go('/purchase-v2/history'),
                    color: Colors.teal,
                  ),
                  _buildFeatureCard(
                    context,
                    icon: Icons.analytics_outlined,
                    title: 'ABC + DSI Report',
                    subtitle: 'Dead stock and Category C audit',
